...
function CartDAO(database) {
    ...
    this.itemInCart = function(userId, itemId, callback) {
         ...
         *
         */
         this.db.collection('cart').find({'userId': userId,  'items': { $elemMatch: { '_id':itemId } } },{ "items.$": 1 }).toArray(function(err,docs){
                       assert.equal(err, null);
                       // TODO-lab3 Replace all code above (in this method).
                      if(null!=docs[0] && null!= docs[0].items && null!= docs[0].items[0])
